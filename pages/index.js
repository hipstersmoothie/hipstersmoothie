      ...
      <div>
        <Layout>
          <Section className="has-text-centered">
            ...
            <p className="subtitle">
              Here are a few projects that I've worked on recently that I'm
              proud of.
            </p>
            ...
            <p className="subtitle" style={{ padding: 60 }}>
              I'm always looking for cool new project to contribute to so don't
              be afraid to <strong>contact me</strong>!
            </p>
          </Section>
              ...
              <VerticalTimeline>
                ...
                <Workplace
                  ...
                  description={
                    <ul style={{ textAlign: 'left' }}>
                      <li>
                        Helped develop the Web Player and Fuego.js - a json
                        driven declarative UI framework written in React
                      </li>
                      <li>
