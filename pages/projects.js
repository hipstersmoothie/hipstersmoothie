...
const Projects = () => (
  <div>
    <Layout active="projects">
      <h1 className="title has-text-centered has-text-grey-dark top">
        New & Noteworthy
      </h1>
      ...
      <DetailedProject
        ...
        subtitle={
          <span>
            ...
            plugin for Ignite. The possibilities for expressive documentation
            are endless!
          </span>
        }
      />
      ...
      <Section className="is-medium">
        <h1 className="title has-text-centered">Original Projects</h1>
        ...
        <h1 className="title has-text-centered">Open Source Contributions</h1>
        ...
        <div className="projects">
          ...
          <Project
            ...
            description={
              <span>
                Turn plain URLs in text into Markdown links. Works in the
